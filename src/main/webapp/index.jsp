...
<title>Prudvi Raj | Portfolio Website</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Prudvi Raj</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/profilepic.png"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To PR
				Portfolio</h1>
			<!-- Icon Divider-->
		...
		<div class="container">
			...
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					href="https://prudvi4.github.io/PrudviRajWebsite/"> Portfolio
					Link! </a>
			</div>
		</div>
	</section>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Prudvi Raj 2023</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
